package home.smart.thuans.centraldevice.watch;
        ...
        switch (requestCode) {
            case REQ_CODE_SPEECH_INPUT: {
                if (resultCode == -1 && null != data) {
                    ...
                    Intent intent = new Intent(SonyActivity.this, MainActivity.class);
                    Bundle b = new Bundle();
                    b.putString(MainActivity.WATCH_STT_CONTENT, result.get(0)); //Your id
            ...
            default: {
                Intent intent = new Intent(SonyActivity.this, MainActivity.class);
                Bundle b = new Bundle();
                b.putString(MainActivity.WATCH_STT_CONTENT, "Em không hiểu. Anh vui lòng nói lại"); //Your id
                intent.putExtras(b); //Put your id to your next Intent
                startActivity(intent);
                this.finish();
